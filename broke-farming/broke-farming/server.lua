...
RegisterServerEvent('broke_farm:giveItem')
AddEventHandler('broke_farm:giveItem', function(item, ItemCount)
...
RegisterServerEvent('broke_sell:SellItem')
AddEventHandler('broke_sell:SellItem', function(ItemValue, ItemPrice, ItemLabel)
